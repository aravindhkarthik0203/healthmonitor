...
public class HealthMonitorController implements Initializable {
        ...
        if (login_username.getText().isEmpty()
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    Data.admin_id = result.getString("admin_id") != null ? Integer.parseInt(result.getString("admin_id")) : 0;
                    ...
                    stage.setTitle("Health Monitor | Admin Portal");
    ...
    public void switchPage() {
        ...
        if (login_user.getSelectionModel().getSelectedItem() == "Admin Portal") {
            ...
            try {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("HealthMonitor-view.fxml"));
                Stage stage = new Stage();
            ...
            try {
                ...
                stage.setTitle("Health Monitor | Doctor Portal");
            ...
            try {
                ...
                stage.setTitle("Health Monitor | Patient Portal");
